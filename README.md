...
This repository contains the code for the paper: "Online vs. Offline Adaptive Domain Randomization Benchmark" submitted to the 15th International Workshop on Human-Friendly Robotics, in June 2022.
